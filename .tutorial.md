...
Navigate to `https://console.cloud.google.com/security/iap?authuser=3&project={{project-id}}` to explore secret manager.
...
Navigate to `https://console.cloud.google.com/net-services/nat/list?authuser=3&project={{project-id}}` to explore Cloud NAT on the Google Cloud console.
...
Navigate to `https://console.cloud.google.com/storage/browser?authuser=3&project={{project-id}}` to explore Cloud Storage bucket on the console.
...
Navigate to `https://console.cloud.google.com/networking/networks/list?authuser=3&project={{project-id}}` to explore Private Google Access configuration on VPC network subnets.
